...
controller.CreateRoomInMaintenance = async function(data){
    try{
        console.log(data);
...
controller.GetRoomInMaintenances = async function(callback){
    try {
...
controller.DeleteRoomInMaintenance = async function (data){
    console.log(data);
